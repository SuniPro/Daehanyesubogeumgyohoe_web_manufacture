...
<form class="form-horizontal register-form" role="form" id="fregisterform" name="fregisterform" action="<?php echo $register_action_url ?>" onsubmit="return fregisterform_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off">
	...
	<div class="card">
		<div class="card-header card-dark"><strong><i class="fa fa-star fa-lg"></i> 사이트 이용정보 입력</strong></div>
		<div class="card-body">
			<div class="form-group has-feedback text-gap">
				<div class='row'>
					<label class="col-md-2 control-label" for="reg_mb_id"><b>아이디</b><strong class="sound_only">필수</strong></label>
					<div class="col-md-3">
			...
			<div class="form-group has-feedback">
				<div class='row'>
					<label class="col-md-2 control-label" for="reg_mb_password"><b>비밀번호</b><strong class="sound_only">필수</strong></label>
					<div class="col-md-3">
						<div class="input-group">
					...
					<label class="col-md-2 control-label" for="reg_mb_password_re"><b>비밀번호 확인</b><strong class="sound_only">필수</strong></label>
					<div class="col-md-3">
						<div class="input-group">
						<div class="input-group-addon"><i class='fa fa-check'></i></div>
	...
	<div class="card">
		<div class="card-header card-dark"><strong><i class="fa fa-user fa-lg"></i> 개인정보 입력</strong></div>
		<div class="card-body">

			<div class="form-group has-feedback<?php echo ($config['cf_cert_use']) ? ' text-gap' : '';?>">
				<div class='row'>
					<label class="col-md-2 control-label" for="reg_mb_name"><b>이름</b><strong class="sound_only">필수</strong></label>
					<div class="col-md-3">
						<div class="input-group">
						<div class="input-group-addon"><i class='fa fa-check'></i></div>
			...
			<?php if ($req_nick) {  ?>
				<div class="form-group has-feedback text-gap">
					<div class='row'>
						<label class="col-md-2 control-label" for="reg_mb_nick"><b>닉네임</b><strong class="sound_only">필수</strong></label>
						<div class="col-md-3">
			...
			<div class="form-group has-feedback<?php echo ($config['cf_use_email_certify']) ? ' text-gap' : '';?>">
				<div class='row'>
					<label class="col-md-2 control-label" for="reg_mb_email"><b>E-mail</b><strong class="sound_only">필수</strong></label>
					<div class="col-md-5">
			...
			<?php if ($config['cf_use_homepage']) {  ?>
				<div class="form-group has-feedback">
					<div class='row'>
						<label class="col-md-2 control-label" for="reg_mb_homepage"><b>홈페이지</b><?php if ($config['cf_req_homepage']){ ?><strong class="sound_only">필수</strong><?php } ?></label>
						<div class="col-md-5">
							<div class="input-group">
			...
			<?php if ($config['cf_use_tel']) {  ?>
				<div class="form-group has-feedback">
					<div class='row'>
						<label class="col-md-2 control-label" for="reg_mb_tel"><b>전화번호</b><?php if ($config['cf_req_tel']) { ?><strong class="sound_only">필수</strong><?php } ?></label>
						<div class="col-md-3">
							<div class="input-group">
			...
			<?php if ($config['cf_use_hp'] || $config['cf_cert_hp']) {  ?>
				<div class="form-group has-feedback">
					<div class='row'>
						<label class="col-md-2 control-label" for="reg_mb_hp"><b>휴대폰번호</b><?php if ($config['cf_req_hp']) { ?><strong class="sound_only">필수</strong><?php } ?></label>
						<div class="col-md-3">
							<div class="input-group">
			...
			<?php if ($config['cf_use_addr']) { ?>
				<div class="form-group has-feedback">
					<div class='row'>
						<label class="col-md-2 control-label"><b>주소</b><?php if ($config['cf_req_addr']) { ?><strong class="sound_only">필수</strong><?php }  ?></label>
						<div class="col-md-8">
	...
	<div class="card">
		<div class="card-header card-dark"><strong><i class="fa fa-cog fa-lg"></i> 기타 개인설정</strong></div>
		<div class="card-body">

			<?php if ($config['cf_use_signature']) {  ?>
				<div class="form-group">
					<div class='row'>
						<label class="col-md-2 control-label" for="reg_mb_signature"><b>서명</b><?php if ($config['cf_req_signature']){ ?><strong class="sound_only">필수</strong><?php } ?></label>
						<div class="col-md-8">
			...
			<?php if ($config['cf_use_profile']) {  ?>
				<div class="form-group">
					<div class='row'>
						<label class="col-md-2 control-label" for="reg_mb_profile"><b>자기소개</b><?php if ($config['cf_req_profile']){ ?><strong class="sound_only">필수</strong><?php } ?></label>
						<div class="col-md-8">
			...
			<?php if ($config['cf_use_member_icon'] && $member['mb_level'] >= $config['cf_icon_level']) {  ?>
				<div class="form-group">
					<div class='row'>
						<label class="col-md-2 control-label" for="reg_mb_profile"><b>회원아이콘</b></label>
						<div class="col-md-8">
			...
			<div class="form-group">
				<div class='row'>
					<label class="col-md-2 control-label" for="reg_mb_mailling"><b>메일링서비스</b></label>
					<div class="col-md-8">
						<div class="checkbox checkbox-primary">
							<input class="styled" type="checkbox" name="mb_mailling" value="1" id="reg_mb_mailling" <?php echo ($w=='' || $member['mb_mailling'])?'checked':''; ?>>
			...
			<?php if ($config['cf_use_hp']) {  ?>
				<div class="form-group">
					<div class='row'>
						<label class="col-md-2 control-label" for="reg_mb_sms"><b>SMS 수신여부</b></label>
						<div class="col-md-8">
							<div class="checkbox checkbox-primary">
								<input class="styled" type="checkbox" name="mb_sms" value="1" id="reg_mb_sms" <?php echo ($w=='' || $member['mb_sms'])?'checked':''; ?>>
			...
			<?php if (isset($member['mb_open_date']) && $member['mb_open_date'] <= date("Y-m-d", G5_SERVER_TIME - ($config['cf_open_modify'] * 86400)) || empty($member['mb_open_date'])) { // 정보공개 수정일이 지났다면 수정가능  ?>
				<div class="form-group">
					<div class='row'>
						<label class="col-md-2 control-label" for="reg_mb_open"><b>정보공개</b></label>
						<div class="col-md-8">
							<input type="hidden" name="mb_open_default" value="<?php echo $member['mb_open'] ?>">
							<div class="checkbox checkbox-primary">
								<input class="styled" type="checkbox" name="mb_open" value="1" id="reg_mb_open" <?php echo ($w=='' || $member['mb_open'])?'checked':''; ?>>
			...
			<?php } else {  ?>
				<div class="form-group">
					<div class='row'>
						<label class="col-md-2 control-label"><b>정보공개</b></label>
						<div class="col-md-8">
							<span class="help-block">
			...
			<?php if ($w == "" && $config['cf_use_recommend']) {  ?>
				<div class="form-group has-feedback">
					<div class='row'>
						<label class="col-md-2 control-label" for="reg_mb_recommend"><b>추천인아이디</b></label>
						<div class="col-md-3">
							<div class="input-group">
							<div class="input-group-addon"><i class='fa fa-user'></i></div>
			...
			<div class="form-group">
				<div class='row'>
					<label class="col-md-2 control-label"><b>자동등록방지</b></label>
					<div class="col-md-8">
	...
	<div class="text-center" style="margin:30px 0px;">
		<button type="submit" id="btn_submit" class="btn btn-primary btn-sm" accesskey="s"><?php echo $w==''?'회원가입':'정보수정'; ?></button>
		<?php if(!$pim) { ?>
			<a href="<?php echo G5_URL ?>" class="btn btn-black btn-sm" role="button">취소</a>
		<?php } ?>
	</div>
