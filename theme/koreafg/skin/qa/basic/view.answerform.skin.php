...
<div class="card no-margin">
	<div class="card-header">
		<h4 class="card-title"><i class="fa fa-comment"></i> 답변하기</h4>
	</div>
	<div class="card-body">
			...
			<div class="write-wrap">
				...
				<input type="hidden" name="page" value="<?php echo $page; ?>">
					...
					<div class="text-center">
						<button type="submit" id="btn_submit" accesskey="s" class="btn btn-info btn-sm"><i class="fa fa-comment"></i> 답변쓰기</button>
					</div>
				</form>
