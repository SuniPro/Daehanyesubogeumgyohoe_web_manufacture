...
<div id='board-container'>
	...
	<div class='gallery-item-wrap'>
		...
		<div class="gallery-items col-lg-<?=$cols?> col-md-4 <?=$ca_name?>">
			...
			?>
			<div class="gallery-item img-over" data-img='<?=$thumb[ori]?>' data-url='<?=$list[$i][href]?>' data-movie='<?=$list[$i][wr_movie_url]?>'>
			...
			<div class="gallery-info">
				<a href="<?=$list[$i][href]?>" class="gallery-title"><?=$list[$i][wr_subject]?></a>
				<div class="date-info">
					<span>by <?=$list[$i][wr_name]?></span>
					<span><i class='fa fa-clock-o'></i> <?=date("m-d",strtotime($list[$i][wr_datetime]))?></span>
				</div>
			</div>
		</div>
