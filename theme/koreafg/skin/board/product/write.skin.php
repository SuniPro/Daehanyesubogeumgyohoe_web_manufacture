...
<input type="hidden" name="page" value="<?php echo $page ?>">
	...
	for($b=2; $b<=10; $b++){
		...
		if($bo_subj){
			$bo_name="wr_".$b;
			$bo_data=$write[$bo_name];
			echo "<div class='form-group clearfix'>";
			echo "<div class='row'>";
			echo "<label class='col-md-2 control-label'>$bo_subj</label>";
			echo "<div class='col-md-10'>";
			echo "<input type='text' name='$bo_name' value='$bo_data' id='$bo_name' required class='form-control form-control-sm' maxlength='255'>";
			echo "</div>";
			echo "</div>";
			echo "</div>";
		}
	...
	<div class="form-group clearfix" style='padding-top:15px;margin:0;'>
		<div class='row'>
