		...
		<li class="item-row <?=$ca_name?>">
			...
			<div class='col-md-3'>
				<div class="webzine-img">
					...
					if ($list[$i]['icon_new']){
						echo "<div class='icon-label icon-new'>New</div>";
					}else if ($list[$i]['icon_hot']){
						echo "<div class='icon-label icon-hot'>Hot</div>";
					}
					?>
					<div class="webzine-item img-over" data-img='<?=$thumb[ori]?>' data-url='<?=$list[$i][href]?>'>
						<div class="wb-thumb">
							<div class='wb-centered'>
								<a href="<?=$list[$i][href]?>">
									...
									<img src="<?=$thumb[src]?>">
									<? }else{ ?>
									<img src='<?=$board_skin_url?>/img/noimage.png' class='img-fluid'>
									<? } ?>
								</a>
							</div>
						</div>
				...
				<div class="webzine-item">
					...
					<div class="webzine-u-info">
						...
						<p class="u-info-links">
							...
							<? } ?>
							<span class="u-info-date"><i class='fa fa-clock-o'></i> <?=$list[$i][datetime2]?></span>
						</p>
					</div>
					<div class="wb-desc">
