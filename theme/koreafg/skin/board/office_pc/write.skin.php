...
<section id="bo_w">
    ...
    if ($is_notice || $is_html || $is_secret || $is_mail) { 
        ...
        if ($is_html) {
            if ($is_dhtml_editor) {
                ...
                $option .= PHP_EOL.'<li class="chk_box" style=display:none><input type="checkbox" id="html" name="html" onclick="html_auto_br(this);" class="selec_chk" value="'.$html_value.'" '.$html_checked.'>'.PHP_EOL.'<label for="html"><span></span>html</label></li>';
            }
        }
        if ($is_secret) {
	...
	<div style=margin-top:10px><input type=text class="frm_input full_input required" name=wr_1 value="<?php echo $write['wr_1']; ?>" placeholder=세로%></div>
	
	<div class="frm_input full_input" style=padding:10px;margin-top:10px>
		<input type=radio name=wr_2 value="yes"<?php echo ($write['wr_2'] == "yes") ? " checked" : ""; ?> required> 기본형
		<input type=radio name=wr_2 style=margin-left:5px value="change"<?php echo ($write['wr_2'] == "change") ? " checked" : ""; ?> required> 변화형 
	</div>
