...
function captcha_html($class="captcha"){
    ...
    $html .= "\n".'<div style="border:0px;width:200px;margin:0 auto;">';
    $html .= "\n".'<div class="pull-left" style="width:160px;height:60px;"><img src="javascript:void(0);" alt="" id="captcha_img" style="width:160px;height:60px;display:block !important;"></div>';
    $html .= "\n".'<div class="pull-right"><div class="btn-group-vertical btn-group-sm" role="group">';
    if (!is_mobile()) $html .= "\n".'<button type="button" id="captcha_mp3" class="btn btn-dark"><i class="fa fa-volume-up fa-fw"></i></button>';
    $html .= "\n".'<button type="button" id="captcha_reload" class="btn btn-dark"><i class="fa fa-refresh fa-fw"></i></button>';
    $html .= "\n".'</div></div>';
    if (is_mobile()) $html .= '<audio src="#" id="captcha_audio" controls style="width:200px;"></audio>';
    $html .= '<input type="text" name="captcha_key" id="captcha_key" required class="form-control form-control-sm" maxlength="6" placeholder="숫자입력">';
    $html .= '</div>';
...
// 캡챠 HTML 코드 출력
function captcha_html_old($class="captcha")
{
    if(is_mobile())
        $class .= ' m_captcha';
